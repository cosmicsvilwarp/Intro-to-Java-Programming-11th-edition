...
class LinearEquationC9E11 {
	public static void main(String[] args) {
		// Create a Scanner object
			...
			// Display results
			System.out.println((linearEquation.isSolvable())? "x is " + linearEquation.getX() + " and y is " + linearEquation.getY() : "The equation has no solution.");
	}
}